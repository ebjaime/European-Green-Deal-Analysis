...
```{r}
plot(seq(2005,2019,0.5), use_wind_elec.diff.total, xlim=range(c(2005,2030)),cex =.5,xlab="Year",ylab="Terajoule",col =" darkgrey ",main='Prediction - Wind Electricity Use',ylim=c(0,100000))
...
ghg.gam.b <- gam(value_ghg ~ s(value_re,bs='cr'), data=vec_ghg)
...
ghg.gam.preds.b <- predict(ghg.gam.b, newdata=vec_ghg_pred, se=T)
