...
```{r}
vec_c02= cbind(Co2$ValueCo2,vec_re$value_re,vec_oil$dif_gdp_eu,vec_oil$dif_pop_eu)
vec_c02 <- data.frame(vec_c02)
...
vec_c02.s=smoothing_procedure(vec_c02.temp,1991,2019,interval=2)
...
```{r}
c02.gam <- gam(value_c02 ~ s(value_re,bs='cr') + s(value_gdp,bs='cr') + s(value_pop,bs='cr') + s(I(value_re*value_gdp),bs='cr') + s(I(value_gdp*value_pop),bs='cr') + s(I(value_re*value_pop),bs='cr') + s(I(value_re*value_gdp*value_pop),bs='cr'), data=vec_c02)
