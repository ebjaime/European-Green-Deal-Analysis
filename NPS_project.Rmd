...
rownames(consump.fossils.diff.s)[!(fit_MCD.1$mcd.wt)]
```
...
gdpp_outliers_mcd <- function(year, alpha=.75, plott=F){
    ...
    # Which are the outliers?
    return(rownames(sd.gdpp.aux)[!(fit_MCD.aux$mcd.wt)]) 
}
...
Let's try to find outlying years from our NRE consumption data which is the base of our prediction models.
