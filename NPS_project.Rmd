...
## 2. Investigate how electricity production coming from renewable sources is growing
...
Now let's perform a nonparametric regression to compare European trends of renewable vs non renewable electricity capacity
```{r}
