...
REVIEW: Smoothing for solar, wind and hydro to obtain data for each month:
```{r}
...
consump.oil.petr.diff.s <- smoothing_procedure(consump.oil.petr.diff.s, 1991, 2019, row_names = rownames(consump.oil.petr.diff.s))
consump.gas.diff.s <- smoothing_procedure(consump.gas.diff.s, 1991, 2019, row_names = rownames(consump.gas.diff.s))
consump.fossils.diff.s <- smoothing_procedure(consump.fossils.diff.s, 1991, 2019, row_names = rownames(consump.fossils.diff.s))
