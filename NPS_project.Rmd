...
# Construct datsets without total European values 
...
```
Construct dataset with percentages of electricity coming from renewables to visualize its evolution at a European level
```{r}
...
ssp  <- read.xlsx("data/ssp_iiasa.xlsx",sheet=1)
