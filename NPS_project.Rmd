...
## EU_NON_RENEWABLE CONSUMPTIONS ~ EU_GDP + EU_POPULATION

Includes three models, one for each non-renewable energy:
    - EU_PETROLEUM  ~ EU_GDP + EU_POPULATION
    - EU_SOLID FOSSIL FUELS ~ EU_GDP + EU_POPULATION
    - EU_NATURAL GAS ~ EU_GDP + EU_POPULATION
